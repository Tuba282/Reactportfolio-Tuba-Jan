...
const Nav = () => {
  ...
  return (
    <div className="nav w-20 fixed right-0 top-0 sm:right-10 sm:top-40 z-[50]  flex justify-center items-center p-3 sm:p-2 py-0 md:py-3">
      ...
      >
        <span className={`block w-7 h-1 bg-gray-100 shadow-sm  shadow-black  rounded transition-all duration-200 ${open ? 'rotate-45 translate-y-2' : ''}`}></span>
        <span className={`block w-7 h-1 bg-gray-100 shadow-sm  shadow-black  rounded my-1 transition-all duration-200 ${open ? 'opacity-0' : ''}`}></span>
        <span className={`block w-7 h-1 bg-gray-100 shadow-sm  shadow-black  rounded transition-all duration-200 ${open ? '-rotate-45 -translate-y-2' : ''}`}></span>
      </button>
      {/* Nav icons container */}
      <div
        className={`w-15 z-[50] shadow-sm shadow-white backdrop-blur-xs bg-white/10 rounded-4xl flex flex-col gap-3 justify-center items-center transition-all duration-300 overflow-hidden xl:overflow-visible
      ...
      >
        ...
        <div className="relative group flex items-center justify-center">
          <a
            href="#hero"
            className="circle bg-white w-10 h-10 rounded-full shadow-xs shadow-gray-700 flex justify-center items-center transition-all duration-150 hover:shadow-xs hover:-translate-y-0.5 active:shadow-inner active:translate-y-[2px] cursor-pointer"
            tabIndex={0}
            onClick={() => setOpen(false)}
          >
            <TbBrandGoogleHome className='text-xl' />
          </a>
        ...
        <div className="relative group flex items-center justify-center">
          <a
            ...
            onClick={() => setOpen(false)}
          >
            <PiCodepenLogoBold className='text-xl' />
          </a>
        ...
        <div className="relative group flex items-center justify-center">
          <a
            ...
            onClick={() => setOpen(false)}
          >
            <MdDiversity2 className='text-xl' />
          </a>
        ...
        <div className="relative group flex items-center justify-center">
          <a
            ...
            onClick={() => setOpen(false)}
          >
            <LuChartNetwork className='text-xl' />
          </a>
