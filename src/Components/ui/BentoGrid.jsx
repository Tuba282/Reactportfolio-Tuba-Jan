...
const items = [
    ...
    { id: "5", cover: "/quizAppCove.png", link: "https://quiz-app-js-pro-09.netlify.app", img: "/quizApp.png", title: 'Quiz App - Sharpen Your Skills, One Question at a Time', desc: 'Quiz App is an interactive platform where users can test their knowledge through engaging multiple-choice questions. The app features a simple and intuitive interface, instant feedback, and a final score to help users track their progress.', type: 'billboard' },
    { id: "6", cover: "/getGoldCover.png", link: "https://get-gold-landing-page-css.netlify.app/", img: "/getGold.png", title: 'Get Gold - Your Premium Gold Collection Awaits', desc: 'Get Gold is a sleek landing page design showcasing a premium offer for gold products. It features a modern layout, elegant typography, and a call-to-action to engage visitors. The website focuses on promoting exclusive deals and capturing user interest through its visually appealing design.', type: 'bottle' },
    { id: "7", cover: "/splytMilk.png", link: "https://splyt-milk.netlify.app/", img: "/splytMilkCover.png", title: '', desc: '', type: 'bottle' },
