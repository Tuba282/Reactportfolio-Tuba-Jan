...
const Hero = () => {
    ...
    return (
        <div  id="hero" className={`w-full min-h-screen relative overflow-hidden transition-all duration-500  `}>
                    ...
                    <div className="icons w-full min-h-11  px-5 md:px-10 flex justify-between items-center z-[20] relative">
                        <div className="left flex items-center gap-3">
                            <LinkPreview url="https://static1.anpoimages.com/wordpress/wp-content/uploads/2022/12/mariia-shalabaieva-whatsapp-unsplash.jpg" className="font-bold">
                                <a target="_blank" href="https://wa.me/923022183767"><img src="https://res.cloudinary.com/dzq61zzxb/image/upload/v1760306499/whatsapp_qaoisd.png" className=' w-8 h-8 btn-press-effect drop-shadow-xs drop-shadow-gray-300' /></a>
                            </LinkPreview>
                            <LinkPreview url="https://techcrunch.com/wp-content/uploads/2020/10/gmail-icon-2020-ios.jpg" className="font-bold">
                                <a target="_blank" href="mailto:tubajan282@gmail.com"><img src="https://res.cloudinary.com/dzq61zzxb/image/upload/v1760306499/google_b5mwsu.png" className=' w-8 h-8 btn-press-effect drop-shadow-xs drop-shadow-gray-300' /></a>
                            </LinkPreview>
                        </div>
                        <div className="right flex items-center gap-3">
                            <LinkPreview url="https://img.freepik.com/free-photo/pile-3d-facebook-logos_1379-875.jpg" className="font-bold">
                                <a target="_blank" href='https://www.facebook.com/'><img src="https://res.cloudinary.com/dzq61zzxb/image/upload/v1760306498/facebook_qmdqri.png" alt="" className=' w-8 h-8 btn-press-effect drop-shadow-xs drop-shadow-gray-300' /></a>
                            </LinkPreview>
                            <LinkPreview url="https://www.eyezy.com/blog/wp-content/uploads/2023/10/how-to-know-if-someone-is-talking-to-someone-else-on-instagram.jpg" className="font-bold">
                                <a target="_blank" href="https://www.instagram.com/tubajan282/"><img src="https://res.cloudinary.com/dzq61zzxb/image/upload/v1760306499/instagram_rmrgsn.png" className=' w-8 h-8 btn-press-effect drop-shadow-xs drop-shadow-gray-300' /></a>
                            </LinkPreview>
                            <LinkPreview url="https://onboardbase.com/blog/github/card.jpg" className="font-bold">
                                <a target="_blank" href='https://github.com/Tuba282'><img src="https://res.cloudinary.com/dzq61zzxb/image/upload/v1760306498/github-sign_qubey2.png" alt="" className=' w-8 h-8 bg-white rounded-sm btn-press-effect drop-shadow-xs drop-shadow-gray-300' /></a>
                            </LinkPreview>
                            <LinkPreview url="https://www.dg-training.co.uk/wp-content/uploads/2018/08/linkedin-911794_1920-1.jpg" className="font-bold">
                                <a target="_blank" href="https://www.linkedin.com/in/tuba-jan-10b0a12b5/"><img src="https://res.cloudinary.com/dzq61zzxb/image/upload/v1760306499/linkedin_r1bqvo.png" className=' w-8 h-8 btn-press-effect drop-shadow-xs drop-shadow-gray-300' /></a>
                            </LinkPreview>
                        </div>
                    </div>
            ...
            <div className="hidden fixed bottom-8 right-8 z-50 flex-row-reverse items-end gap-3 transition-all duration-200">
                <button
